    ...
    <div class="col-xs-12">
                                ...
                                <td class="thread-options">
                                    <p>
                                        <?php if ( bp_message_thread_has_unread() ) : ?>
                                            <a class="read btn btn-default" href="<?php bp_the_message_thread_mark_read_url();?>"><i class="fa fa-eye"></i> <?php _e( 'Read', 'buddypress' ); ?></a>
                                        <?php else : ?>
                                            <a class="unread btn btn-default" href="<?php bp_the_message_thread_mark_unread_url();?>"><i class="fa fa-eye-slash"></i> <?php _e( 'Unread', 'buddypress' ); ?></a>
                                        <?php endif; ?>
                                    </p>
                                    <p>
                                        <a class="delete btn btn-danger" href="<?php bp_message_thread_delete_link(); ?>"><i class="fa fa-trash-o"></i> <?php _e( 'Delete', 'buddypress' ); ?></a>
                                    </p>
                                </td>
                            </tr>
        ...
        <?php else: ?>
            ...
            <div id="message" class="alert alert-info">
                <p><i class="fa fa-info"></i> <?php _e( 'Sorry, no messages were found.', 'buddypress' ); ?></p>
            </div>
