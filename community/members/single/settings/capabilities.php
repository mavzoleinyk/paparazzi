...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/capabilities/'; ?>" name="account-capabilities-form" id="account-capabilities-form" class="standard-form" method="post">
    ...
    <div class="form-group">
        ...
        <div class="checkbox">
            ...
            <label>
                <input type="checkbox" class="form-control" name="user-spammer" id="user-spammer" value="1" <?php checked( bp_is_user_spammer( bp_displayed_user_id() ) ); ?> />
	...
	<div class="submit form-group">
		<input type="submit" value="<?php esc_attr_e( 'Save', 'buddypress' ); ?>" id="capabilities-submit" name="capabilities-submit" class="btn btn-primary" />
	</div>
