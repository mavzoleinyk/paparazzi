...
<div id="buddypress">
    ...
    <ul class="nav nav-pills">
        ...
        <li><a href="<?php bloginfo('url'); ?>/comanies/">Companies</a></li>
        <li class="active"><a href="<?php bloginfo('url'); ?>/members/">Members</a></li>
	...
	<form action="" method="post" id="members-directory-form" class="dir-form">
		...
		<div class="row">
            <div id="members-dir-search" class="col-xs-12 col-sm-6 dir-search" role="search">
