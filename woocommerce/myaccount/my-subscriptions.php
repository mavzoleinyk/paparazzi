...
<div class="table-responsive">
    <table class="table table-hover shop_table shop_table_responsive my_account_subscriptions my_account_orders">
            ...
            <tr class="order">
                ...
                <td class="subscription-actions order-actions" data-title="<?php _e( 'Actions', 'woocommerce-subscriptions' ); ?>">
                    <?php foreach( $actions[ $subscription_key ] as $key => $action ) : ?>
                        <a href="<?php echo esc_url( $action['url'] ); ?>" class="btn btn-link <?php echo sanitize_html_class( $key ) ?>"><?php echo esc_html( $action['name'] ); ?></a>
                    <?php endforeach; ?>
                    <a class="btn btn-link" href="<?php bloginfo('url'); ?>/modify-regions/">Modify Regions</a>
                    <a class="btn btn-link" href="<?php bloginfo('url'); ?>/company-members/">Company Members</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
...
<?php else : ?>
	...
	<p><?php printf( __( 'You have no active subscriptions. Find your first subscription in the %sstore%s.', 'woocommerce-subscriptions' ), '<a href="' . apply_filters( 'woocommerce_subscriptions_message_store_url', get_permalink( woocommerce_get_page_id( 'shop' ) ) ) . '">', '</a>' ); ?></p>
